...
`blog-api` 연동, 소유자 로그인/글쓰기(작성·수정·삭제·숨김·고정, 이미지 업로드), 검색, 조회수·인기글 통계까지 v1 스코프는 기능 구현·검증이 끝났고 Vercel 배포도 완료되어 [운영 중](https://gyujin-log.vercel.app/)입니다.
